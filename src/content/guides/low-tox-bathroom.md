...
1. **"Fragrance" / "parfum."** A legal catch-all that can hide dozens of undisclosed
   ingredients. Choose products scented with **named essential oils**, or go fragrance-free.
2. **The length of the list.** As a rough rule, **fewer ingredients** you can pronounce is
   a good sign. You don't need twenty to moisturise.
3. **Marketing vs. meaning.** "Natural," "clean" and "green" are unregulated words.
...
> The lowest-tox product is often the simplest one. When a label reads like a short
> recipe rather than a chemistry set, you're usually on the right track.
